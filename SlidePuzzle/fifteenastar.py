...
class Heap:
    ...
    def update(self, state, priority, newParent):
        index = self.indecies[state]
        currTup = self.array[index]
        newTup = (priority, currTup[1], currTup[2], newParent)
        self.array[index] = newTup
        self.heapUp(index)
